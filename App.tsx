...
import StoreComparisonPage from './pages/admin/StoreComparisonPage'; // New Import for Chairman's Dashboard
            ...
            <>
              ...
              {isChairman && (
                <>
                  ...
                  <Route path="/admin/store-comparison" element={<StoreComparisonPage />} />
                </>
              )}
