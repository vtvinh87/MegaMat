...
const OrderPrintPreviewPage: React.FC = () => {
  ...
  const { findOrder, findStoreProfileByOwnerId } = useAppContext(); // Added findStoreProfileByOwnerId
      ...
      <div className="no-print mt-4 mb-8 flex flex-col items-center">
         <Card title="Xem trước & In Hóa Đơn" className="w-full max-w-xl mb-6">
            ...
            <div className="flex space-x-3 justify-center">
                ...
                <Button onClick={() => navigate('/admin/orders')} variant="secondary" leftIcon={<ArrowLeftIcon size={18}/>}>
                    Về danh sách đơn hàng
                </Button>
            </div>
         </Card>
