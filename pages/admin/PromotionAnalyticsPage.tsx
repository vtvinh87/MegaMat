        ...
        <div className="space-y-6">
            ...
            <Card title="Tổng quan Phân tích Khuyến mãi" icon={<BarChart2Icon size={22} className="text-brand-primary" />}>
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm mt-3 pt-3 border-t border-border-base">
                    ...
                    <div className="flex items-center"><InfoIcon size={16} className="mr-2 text-text-muted" /> Trạng thái: {promotion.status === 'active' ? <span className="flex items-center text-status-success ml-1"><CheckCircle size={14} className="mr-1"/>Hoạt động</span> : <span className="flex items-center text-status-danger ml-1"><XCircle size={14} className="mr-1"/>Không hoạt động</span>}</div>
