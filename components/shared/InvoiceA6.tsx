...
export const InvoiceA6: React.FC<InvoiceA6Props> = ({ order, storeProfile }) => {
  ...
  const { customer, items, totalAmount, createdAt, estimatedCompletionTime, receivedAt } = order;
  ...
  return (
    <div className="invoice-a6-container bg-white text-gray-800 p-3 font-sans">
      ...
      <div className="totals">
        <p className="grand-total">TỔNG CỘNG: {totalAmount.toLocaleString('vi-VN')} VNĐ</p>
        <p className="payment-status">TRẠNG THÁI: ĐÃ THANH TOÁN (Hoặc sẽ thanh toán khi nhận đồ)</p>
      </div>
